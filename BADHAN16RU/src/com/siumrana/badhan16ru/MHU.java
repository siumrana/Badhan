...
public class MHU extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_mhu);
		...
		b101.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				cl.setData(Uri.parse("tel:01723936595"));
				startActivity(cl);
			}
		...
		b102.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent cl=new Intent(Intent.ACTION_CALL);
				cl.setData(Uri.parse("tel: 01723825191"));
				startActivity(cl);
			}
		...
		b103.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent cl=new Intent(Intent.ACTION_CALL);
				cl.setData(Uri.parse("tel:01737878455"));
				startActivity(cl);
			}
		...
		b104.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent cl=new Intent(Intent.ACTION_CALL);
				cl.setData(Uri.parse("tel:01773151011"));
				startActivity(cl);
			}
		...
		b105.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent cl=new Intent(Intent.ACTION_CALL);
				cl.setData(Uri.parse("tel:01741476876"));
				startActivity(cl);
			}
		...
		b107.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent cl=new Intent(Intent.ACTION_CALL);
				cl.setData(Uri.parse("tel:01793044990"));
				startActivity(cl);
			}
		...
		b108.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent cl=new Intent(Intent.ACTION_CALL);
				cl.setData(Uri.parse("tel:01935263773"));
				startActivity(cl);
			}
		...
		b109.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent cl=new Intent(Intent.ACTION_CALL);
				cl.setData(Uri.parse("tel:01521500726"));
				startActivity(cl);
			}
		...
		b110.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent cl=new Intent(Intent.ACTION_CALL);
				cl.setData(Uri.parse("tel:01756600815"));
				startActivity(cl);
			}
		...
		b111.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent cl=new Intent(Intent.ACTION_CALL);
				cl.setData(Uri.parse("tel:01764073098"));
				startActivity(cl);
			}
		...
		b112.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent cl=new Intent(Intent.ACTION_CALL);
				cl.setData(Uri.parse("tel:01767229034"));
				startActivity(cl);
			}
		...
		b113.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent cl=new Intent(Intent.ACTION_CALL);
				cl.setData(Uri.parse("tel:01797760011"));
				startActivity(cl);
			}
		...
		b114.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent cl=new Intent(Intent.ACTION_CALL);
				cl.setData(Uri.parse("tel:01774273005 "));
				startActivity(cl);
			}
		...
		b115.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent cl=new Intent(Intent.ACTION_CALL);
				cl.setData(Uri.parse("tel:01731711910"));
				startActivity(cl);
			}
		...
		b118.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent cl=new Intent(Intent.ACTION_CALL);
				cl.setData(Uri.parse("tel:01723769283"));
				startActivity(cl);
			}
		...
		b119.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent cl=new Intent(Intent.ACTION_CALL);
				cl.setData(Uri.parse("tel:01745999832"));
				startActivity(cl);
			}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.mhu, menu);
		return true;
	}
